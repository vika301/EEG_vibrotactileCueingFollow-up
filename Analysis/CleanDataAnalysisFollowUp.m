...
eeg_cleaned_ankle_swapped_odd.orig_indices = indices_ankle_swapped_odd;
eeg_cleaned_ankle_swapped_stand.orig_indices = indices_ankle_swapped_stand;
eeg_cleaned_ankle_odd.orig_indices = indices_ankle_odd;
eeg_cleaned_ankle_stand.orig_indices = indices_ankle_stand;
eeg_cleaned_visual_swapped_odd.orig_indices = indices_visual_swapped_odd;
eeg_cleaned_visual_swapped_stand.orig_indices = indices_visual_swapped_stand;
...
eeg_cleaned_ankle_swapped_odd = pop_rmbase(eeg_cleaned_ankle_swapped_odd, [-199 0]);
eeg_cleaned_ankle_swapped_stand = pop_rmbase(eeg_cleaned_ankle_swapped_stand, [-199 0]);
...
eeg_cleaned_visual_swapped_odd = pop_rmbase(eeg_cleaned_visual_swapped_odd, [-199 0]);
eeg_cleaned_visual_swapped_stand = pop_rmbase(eeg_cleaned_visual_swapped_stand, [-199 0]);
end
...
% save the file 
cd(saving_path);
eeg_cleaned.filename = eeg_cleaned.filename(1:end-4);
% the waist condition
...
% the wrist condition
pop_saveset(eeg_cleaned_ankle_swapped_odd, 'filename', sprintf('%s_cleaned_ankle_swapped_odd.set', eeg_cleaned.filename), 'filepath', eeg_cleaned_ankle_swapped_odd.filepath);
pop_saveset(eeg_cleaned_ankle_swapped_stand, 'filename', sprintf('%s_cleaned_ankle_swapped_stand.set', eeg_cleaned.filename), 'filepath', eeg_cleaned_ankle_swapped_stand.filepath);
% the ankle condition
...
pop_saveset(eeg_cleaned_visual_swapped_odd, 'filename', sprintf('%s_cleaned_visual_swapped_odd.set', eeg_cleaned.filename), 'filepath', eeg_cleaned_visual_swapped_odd.filepath);
pop_saveset(eeg_cleaned_visual_swapped_stand, 'filename', sprintf('%s_cleaned_visual_swapped_stand.set', eeg_cleaned.filename), 'filepath', eeg_cleaned_visual_swapped_stand.filepath);
